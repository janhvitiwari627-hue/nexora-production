  ...
  public: {
    Tables: {
      ...
      growth_partner_applications: {
        Row: {
          beauty_industry_experience: string;
          city: string;
          created_at: string;
      ...
      payment_ledger: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "payment_ledger_salon_id_fkey";
            columns: ["salon_id"];
            isOneToOne: false;
            referencedRelation: "salons";
            referencedColumns: ["id"];
      ...
      referral_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "referral_transactions_attribution_id_fkey";
      ...
      review_reports: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "review_reports_salon_id_fkey";
            columns: ["salon_id"];
            isOneToOne: false;
            referencedRelation: "salons";
            referencedColumns: ["id"];
      ...
      reward_transactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "reward_transactions_payment_id_fkey";
            columns: ["payment_id"];
            isOneToOne: false;
            referencedRelation: "payments";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "reward_transactions_referral_attribution_fkey";
      ...
      user_websites: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_websites_business_category_id_fkey";
            columns: ["business_category_id"];
            isOneToOne: false;
            referencedRelation: "website_template_categories";
            referencedColumns: ["id"];
          },
          {
      ...
      wallet_ledger: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "wallet_ledger_salon_id_fkey";
            columns: ["salon_id"];
            isOneToOne: false;
            referencedRelation: "salons";
            referencedColumns: ["id"];
      ...
      wallet_settlements: {
        ...
        Relationships: [
          {
            foreignKeyName: "wallet_settlements_salon_id_fkey";
            columns: ["salon_id"];
            isOneToOne: false;
            referencedRelation: "salons";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "wallet_settlements_wallet_id_fkey";
            columns: ["wallet_id"];
            isOneToOne: false;
            referencedRelation: "salon_wallets";
            referencedColumns: ["id"];
      ...
      website_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "website_templates_category_id_fkey";
            columns: ["category_id"];
            isOneToOne: false;
            referencedRelation: "website_template_categories";
            referencedColumns: ["id"];
    ...
    Views: {
      ...
      tenants: {
        Row: {
          ...
          selected_template_id: string | null;
          selected_template_key: string | null;
          show_public_contact: boolean | null;
          slug: string | null;
          tagline: string | null;
          theme: string | null;
          updated_at: string | null;
    ...
    Enums: {
      ...
      dbp_earning_type: "activation_reward" | "growth_share" | "bonus" | "milestone_bonus";
      ...
      dbp_tier: "welcome" | "recognition" | "growth_builder" | "platinum" | "leadership_circle";
      reward_type: "points" | "cashback" | "referral" | "membership" | "admin_bonus";
      ...
      transaction_type:
        ...
        | "reward_credit"
        | "referral_bonus";
      user_role: "super_admin" | "shop_owner" | "shop_manager" | "staff" | "customer";
    };
    CompositeTypes: {
      [_ in never]: never;
    };

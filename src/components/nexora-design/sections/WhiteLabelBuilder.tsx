...
const templates = [
  {
    name: "Luxe Salon",
    image: "https://images.pexels.com/photos/7195802/pexels-photo-7195802.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=700&w=1100",
    color: "from-indigo-500 to-violet-600",
  },
  {
    name: "Spa Retreat",
    image: "https://images.pexels.com/photos/7031707/pexels-photo-7031707.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=700&w=1100",
    color: "from-emerald-500 to-teal-600",
  },
  {
    name: "Ink Studio",
    image: "https://images.pexels.com/photos/28991658/pexels-photo-28991658.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=700&w=1100",
    color: "from-slate-700 to-slate-900",
  },
  {
    name: "Bridal Muse",
    image: "https://images.pexels.com/photos/13779727/pexels-photo-13779727.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=700&w=1100",
              ...
              >
                ...
                <div className="flex items-center gap-2 border-b border-slate-100 bg-slate-50 px-4 py-3">
                  ...
                  <div className="ml-4 h-6 flex-1 rounded-md bg-white text-[10px] leading-6 text-slate-400">
                    <span className="pl-3">{tpl.name.toLowerCase().replace(/ /g, "")}.nexora.site</span>
                  </div>
                </div>
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 translate-y-4 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100">
                    <span className={`inline-block rounded-full bg-gradient-to-r ${tpl.color} px-4 py-2 text-xs font-bold text-white shadow-lg`}>
                      Preview {tpl.name}
                    </span>
                  </div>
                </div>
                <div className="flex items-center justify-between p-5">
                  <div>
                    ...
                    <ul className="mt-2 flex flex-wrap gap-2">
                      {["Booking", "Payments", "Analytics"].map((f) => (
                        <li
                          key={f}
                  ...
                  <button className="rounded-full bg-slate-900 p-2.5 text-white transition-transform hover:scale-110 active:scale-95">

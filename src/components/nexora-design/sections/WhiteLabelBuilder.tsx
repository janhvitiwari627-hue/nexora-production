          ...
          <FadeIn>
            <div className="max-w-2xl">
              ...
              <p className="mt-5 text-lg text-slate-500">
                Choose a premium template, customize your services, and publish a stunning website
                for your salon in minutes.
              </p>
          ...
          <div className="flex gap-6 overflow-x-auto pb-8 pt-4 hide-scrollbar snap-x snap-mandatory">
            {isLoading ? (
              ...
              templates.map((tpl, idx) => {
                ...
                const slug = (tpl.template_slug ?? tpl.template_key ?? tpl.template_name)
                  .toLowerCase()
                  .replace(/\s+/g, "");
                    ...
                    <div className="flex items-center justify-between p-5">
                      <div>
                        ...
                        <ul className="mt-2 flex flex-wrap gap-2">
                          {[tpl.category ?? "Salon", tpl.theme_type ?? "Premium", "Booking"].map(
                            (f) => (
                              <li
                                key={f}

...
export const MOCK_SHOP: ShopData = {
  ...
  reviewCount: 412,
  about:
    "Award-winning salon delivering premium hair, beauty, and wellness experiences since 2015.",
  services: [
    {
      id: "s0",
      name: "Haircut & Style",
      ...
      discountPrice: 650,
      duration: 45,
      desc: "Expert cut by certified stylists.",
      image: stockImg("srv0"),
      category: "Hair",
      popular: true,
    },
    {
      ...
      discountPrice: 1999,
      duration: 90,
      desc: "Premium L'Oréal color treatments.",
      image: stockImg("srv1"),
      category: "Hair",
      popular: true,
    },
    {
      ...
      price: 4500,
      duration: 120,
      desc: "Smoothing keratin therapy.",
      image: stockImg("srv2"),
      category: "Hair",
    },
    {
      ...
      discountPrice: 1499,
      duration: 60,
      desc: "Glow-boosting facial ritual.",
      image: stockImg("srv3"),
      category: "Skin",
      popular: true,
    },
  ...
  staff: [
    ...
    },
    {
      ...
      image: stockImg("staff1"),
      experience: 10,
      specialization: "Beard · Fade",
      rating: 4.8,
      available: true,
    },
    {
      ...
      image: stockImg("staff2"),
      experience: 6,
      specialization: "Facial · Bridal",
      rating: 4.9,
      available: false,
    },
    {
  ...
  reviews: [
    {
      ...
      author: "Aarav",
      rating: 5,
      text: "Loved the service! Highly recommend.",
      date: "1w ago",
      source: "google",
    },
    {
      ...
      author: "Priya",
      rating: 5,
      text: "Best salon experience in Mumbai.",
      date: "2w ago",
      photo: stockImg("rev1"),
      source: "site",
    },
    {
      ...
      author: "Sneha",
      rating: 5,
      text: "Staff is so warm and skilled!",
      date: "3w ago",
      source: "google",
    },
    {
  ...
  offers: [
    ...
    },
    {
      id: "o2",
      title: "Weekday Glow",
      description: "15% off all weekday services",
      discount: "15%",
    },
  ],
  packages: [
    {
      ...
      price: 12999,
      originalPrice: 18000,
      services: ["Pre-bridal facial", "Hair styling", "Mehendi", "Makeup trial"],
      duration: "Full day",
    },
    {
      id: "p2",
      ...
      price: 4999,
      originalPrice: 6500,
      services: ["Couple massage", "Facial", "Manicure"],
      duration: "3 hours",
    },
    {
      id: "p3",
      ...
      price: 2499,
      originalPrice: 3500,
      services: ["2x Haircut", "1x Facial", "1x Manicure"],
      duration: "Monthly",
    },
  ],
  memberships: [
    {
      ...
      tier: "Silver",
      price: 499,
      benefits: ["5% off all services", "Priority booking", "Birthday voucher"],
    },
    {
      id: "m2",
      tier: "Gold",
      price: 999,
      benefits: ["10% off all", "1 free service/month", "Birthday voucher", "Free consultation"],
      popular: true,
    },
    {
      id: "m3",
      tier: "Platinum",
      price: 1999,
      benefits: ["15% off all", "Free home visits", "VIP concierge", "Festival rewards"],
    },
  ],
  loyalty: {
    pointsPerVisit: 50,
    referralPoints: 200,
    birthdayReward: "Free facial worth ₹1800",
    festivalReward: "Up to 30% off festival packages",
  },
  blog: [
    {
      id: "b1",
      slug: "monsoon-hair-care",
      title: "5 Monsoon Hair Care Tips",
      excerpt: "Keep your hair healthy this season.",
      image: stockImg("blog1"),
      date: "Jun 18, 2026",
    },
    {
      id: "b2",
      slug: "bridal-glow-guide",
      title: "The Ultimate Bridal Glow Guide",
      excerpt: "Everything to prep before your big day.",
      image: stockImg("blog2"),
      date: "Jun 10, 2026",
    },
    {
      id: "b3",
      ...
      excerpt: "What's hot in colors this year.",
      image: stockImg("blog3"),
      date: "May 28, 2026",
    },
  ],
  coupons: [
    { id: "c1", code: "WELCOME20", discount: "20% off" },
    { id: "c2", code: "FEST500", discount: "₹500 off" },
  ],
  awards: [
    { title: "Best Salon Mumbai", year: 2024 },
    { title: "Top Bridal Studio", year: 2023 },
  ],
  brands: [
    { name: "L'Oréal" },
    { name: "Schwarzkopf" },

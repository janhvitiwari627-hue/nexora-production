    ...
    <section className="px-6 py-16 md:px-12">
      ...
      <div className="mt-8 grid gap-2 md:grid-cols-6">
        {shop.gallery.slice(0, 6).map((g, i) => (
          <a key={i} href={`https://instagram.com/${shop.instagramHandle}`} target="_blank" rel="noopener noreferrer" className="group relative block aspect-square overflow-hidden">
            <img src={g.url} alt={`Instagram ${i + 1}`} loading="lazy" className="h-full w-full object-cover transition-transform group-hover:scale-110" />

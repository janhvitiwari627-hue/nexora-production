  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-20 border-t bg-white px-4 py-3 shadow-2xl md:hidden">
      <div className="flex items-center justify-between gap-3">
        ...
        <a href="#appointment" className="inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-white" style={{ backgroundColor: template.colors.primary, borderRadius: template.radius }}>

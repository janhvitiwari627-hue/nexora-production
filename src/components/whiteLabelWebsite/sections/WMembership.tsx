  ...
  return (
    <section id="membership" className="px-6 py-16 md:px-12">
      ...
      <p className="text-muted-foreground mt-2 text-center text-sm">
        Silver · Gold · Platinum — pick the perks that suit you.
      </p>
        ...
        {shop.memberships.map((m) => {
          ...
          return (
            ...
            >
              {featured && (
                <span
                  className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-white px-3 py-1 text-[10px] font-bold uppercase tracking-wider shadow"
              ...
              <div className="mt-5 flex items-center gap-2">
                ...
                <ShareButton
                  title={`${m.tier} membership at ${shop.name}`}
                  label=""
                  className={featured ? "!text-white !bg-white/10" : ""}
                />
              </div>
            </article>
          );

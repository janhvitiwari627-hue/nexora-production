...
export const Route = createFileRoute("/portal/distributors/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Find verified beauty product distributors, wholesalers and super stockists across Indian states and districts on Nexora." },
      { property: "og:title", content: "Beauty Distributors — Nexora" },
      { property: "og:description", content: "Verified distributors and wholesalers across India." },

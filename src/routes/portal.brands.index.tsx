...
export const Route = createFileRoute("/portal/brands/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Browse verified beauty brands, manufacturers and importers across India. Discover products, distributors and contacts on Nexora." },
      { property: "og:title", content: "Beauty Brand Directory — Nexora" },
      { property: "og:description", content: "Verified beauty brands and manufacturers across India." },

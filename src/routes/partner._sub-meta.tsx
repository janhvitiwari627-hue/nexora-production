...
import { ComingSoonCard, PartnerPageShell } from "@/pages/partner/PartnerAppLayout";

type Meta = { title: string; subtitle: string; icon: ComponentType<{ className?: string }>; note: string };

export const PARTNER_SUBPAGES: Record<string, Meta> = {
  leads: {
    title: "Leads",
...
// Fallback route (unused but keeps this file a valid route module target for tree)
export const Route = createFileRoute("/partner/_sub-meta")({
  component: () => null,
});

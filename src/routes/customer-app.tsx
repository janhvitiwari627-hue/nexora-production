...
export const Route = createFileRoute("/customer-app")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The Nexora Customer App is launching separately. Join the waitlist to book salons, scan-and-pay and earn rewards on Android, iOS and web." },
      { property: "og:title", content: "Nexora Customer App — Coming Soon" },
      { property: "og:description", content: "The Nexora Customer App is launching separately. Join the waitlist." },

  ...
  head: () => ({
    meta: [
      { title: "Distributor & Brand Portal — Nexora" },
      {
        name: "description",
        content:
          "Promote your beauty brand, products and distribution network across thousands of salons and beauty businesses on Nexora.",
      },
      { property: "og:title", content: "Distributor & Brand Portal — Nexora" },
      {
        property: "og:description",
        content:
          "Grow your beauty brand across India — connect with salons, spas and beauty retailers.",
      },

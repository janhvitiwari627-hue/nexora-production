...
export function SmsNotConfiguredAlert({
  originalMessage,
}: {
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-2 text-sm">
          <p className="font-semibold text-destructive">
            SMS sending isn't configured yet
          </p>
          <p className="text-muted-foreground">
            Nexora couldn't deliver the one-time code because the Phone (SMS)
            provider hasn't been set up on the backend.
          </p>
          <div className="text-muted-foreground">
            <p className="mb-1 font-medium text-foreground">To fix this:</p>
            <ol className="ml-4 list-decimal space-y-1">
              <li>Open the backend Users → Auth Settings.</li>
              <li>Enable the <span className="font-medium">Phone</span> provider.</li>
              <li>
                Add SMS gateway credentials (e.g. Twilio Account SID, Auth
                Token, and Message Service SID or From number).
              </li>

      ...
      <div className="grid gap-6 md:grid-cols-[1fr_1.5fr]">
        <div className="space-y-4">
          ...
          {(() => {
            const socials = [
              {
                url: import.meta.env.VITE_SOCIAL_INSTAGRAM as string | undefined,
                label: "Instagram",
                Icon: Instagram,
              },
              {
                url: import.meta.env.VITE_SOCIAL_FACEBOOK as string | undefined,
                label: "Facebook",
                Icon: Facebook,
              },
              {
                url: import.meta.env.VITE_SOCIAL_LINKEDIN as string | undefined,
                label: "LinkedIn",
                Icon: Linkedin,
              },
            ].filter((s) => s.url);
          ...
          <div className="bg-muted h-40 overflow-hidden rounded-lg">
            <iframe
              ...
              src="https://www.openstreetmap.org/export/embed.html?bbox=77.62%2C12.97%2C77.65%2C12.99&layer=mapnik"
              loading="lazy"
            />
          </div>
        </div>

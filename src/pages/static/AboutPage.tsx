...
const MILESTONES = [
  {
    ...
    desc: "Started with a mission to digitize India's salon industry.",
  },
    ...
    <div className="mx-auto max-w-5xl space-y-12 p-6 md:p-12">
      <section className="text-center">
        <h1 className="text-heading text-4xl font-bold md:text-5xl">
          We're building the OS for beauty businesses
        </h1>
        <p className="text-muted-foreground mx-auto mt-4 max-w-2xl text-lg">
          From bookings to billing, marketing to memberships — Nexora empowers India's salon
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <p className="text-muted-foreground mt-2">
              Democratize technology for every salon, spa, and studio owner in India.
            </p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-6">
            ...
            <p className="text-muted-foreground mt-2">
              A world where every beauty professional can build, grow, and thrive with the tools
              they deserve.
            </p>
          </CardContent>
        </Card>
      ...
      <section>
        <h2 className="mb-6 text-center text-2xl font-bold flex items-center justify-center gap-2">
        ...
        <ol className="relative space-y-6 border-l-2 pl-6">
          {MILESTONES.map((m, i) => (
            <li key={i} className="relative">
              <div className="bg-primary absolute -left-[31px] grid h-6 w-6 place-items-center rounded-full text-xs font-bold text-white">
                {i + 1}
              </div>

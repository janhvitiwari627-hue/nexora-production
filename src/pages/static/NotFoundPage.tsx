  ...
  return (
    <div className="grid min-h-[80vh] place-items-center px-6">
      <div className="max-w-md text-center">
        ...
        <p className="text-muted-foreground mt-1 text-sm">The page may have moved, or the link is broken.</p>
        <div className="mt-6 flex flex-col gap-2 sm:flex-row sm:justify-center">
          <Button asChild className="bg-gradient-to-r from-primary to-accent"><a href="/"><Home className="h-4 w-4" /> Go Home</a></Button>
          <Button asChild variant="outline"><a href="/"><Search className="h-4 w-4" /> Search Services</a></Button>
        </div>
      </div>
    </div>
  );

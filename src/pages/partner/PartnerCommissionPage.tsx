...
const ACT: {
  ...
  {
    shop: "Glow Studio",
    firstCollection: "12 Jun",
    revenue: "₹1,500",
    commission: "₹150",
    status: "Paid",
  },
  {
    shop: "The Barber Loft",
    firstCollection: "14 Jun",
    revenue: "₹1,650",
    commission: "₹165",
    status: "Paid",
  },
                ...
                {ACT.map((r, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <Pill text={r.status} tone={ACT_TONE[r.status]} />
                    </td>
                  </motion.tr>
                ))}
              </tbody>
              ...
              <tbody className="divide-y divide-slate-100">
                {REC.map((r, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <Pill text={r.status} tone={REC_TONE[r.status]} />
                    </td>
                  </motion.tr>
                ))}
              </tbody>
...
function SummaryCard({
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5">
      <div
        className={`inline-flex rounded-lg px-2 py-1 text-[10px] font-bold uppercase tracking-wider ${map[tone]}`}
      >
        {label}
      </div>

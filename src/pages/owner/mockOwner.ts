...
export const revenueMonthly = [
  ...
  label: m,
  revenue: 180000 + Math.round(Math.sin(i) * 20000 + rMonthly() * 30000 + i * 4000),
}));
...
export const calendarFirstWeekday = new Date(
  Date.UTC(now.getUTCFullYear(), now.getUTCMonth(), 1),
).getUTCDay();
export const calendarMonthLabel = new Date(
  Date.UTC(now.getUTCFullYear(), now.getUTCMonth(), 1),
...
export const recentReviews = [
  {
    ...
    author: "Priya S.",
    rating: 5,
    text: "Best hair color experience I've had in years — Anjali is magic!",
  },
  {
    id: "r2",
    author: "Kunal M.",
    rating: 4,
    text: "Loved the head massage. Could improve waiting area comfort.",
  },
  {
    id: "r3",
    author: "Riya K.",
    rating: 5,
    text: "Facial left my skin glowing for days. Booking again next week.",
  },
];

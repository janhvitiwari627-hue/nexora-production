  ...
  return (
    <Table>
      <TableHeader>
        <TableRow>
          <TableHead>
            <SortBtn active={key === "name"} dir={dir} onClick={() => toggle("name")}>
              Staff
            </SortBtn>
          </TableHead>
          <TableHead>
            <SortBtn active={key === "bookings"} dir={dir} onClick={() => toggle("bookings")}>
              Bookings
            </SortBtn>
          </TableHead>
          <TableHead>
            <SortBtn active={key === "revenue"} dir={dir} onClick={() => toggle("revenue")}>
              Revenue
            </SortBtn>
          </TableHead>
          <TableHead>
            <SortBtn active={key === "rating"} dir={dir} onClick={() => toggle("rating")}>
              Rating
            </SortBtn>
          </TableHead>

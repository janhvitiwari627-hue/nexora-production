...
const FEATURES = [
  {
    icon: Tag,
    title: "Brand Profile",
    body: "Build your professional company profile with logo, story and contact.",
  },
  {
    icon: Package,
    title: "Product Showcase",
    body: "Display your complete product range with pricing and imagery.",
  },
  {
    icon: Star,
    title: "Sponsored Listings",
    body: "Get top visibility in directories, search and category pages.",
  },
  {
    icon: Building2,
    title: "Business Pages",
    body: "Dedicated SEO-friendly business pages for your brand.",
  },
  {
    icon: Megaphone,
    title: "Product Promotion",
    body: "Promote products directly to thousands of industry businesses.",
  },
  {
    icon: Globe,
    title: "Industry Visibility",
    body: "Increase market reach across India's beauty ecosystem.",
  },
  {
    icon: LayoutDashboard,
    title: "Distributor Dashboard",
    body: "Manage your network, territory and opportunities in one place.",
  },
  {
    icon: Target,
    title: "Lead Opportunities",
    body: "Receive qualified business inquiries directly to your inbox.",
  },
];
  ...
  return (
    <PortalLayout>
      ...
      <section className="relative overflow-hidden rounded-[var(--radius-card-lg)] border border-border/60 bg-gradient-to-br from-primary/10 via-card to-accent/10 p-8 md:p-14">
        ...
        />
        <div
          className="absolute -bottom-24 -left-16 h-72 w-72 rounded-full bg-accent/20 blur-3xl"
          aria-hidden
        />
        <div className="relative max-w-3xl animate-fade-in">
          ...
          <p className="mt-4 text-pretty text-base text-body md:text-lg">
            Connect with salons, beauty parlours, spas, nail studios, tattoo studios, massage
            centers and beauty retailers through Nexora.
          </p>
      ...
      <section className="mt-12">
        <div className="mb-6 max-w-2xl">
          ...
          <p className="mt-2 text-sm text-body">
            A complete growth toolkit built for brands, distributors and suppliers.
          </p>
        </div>
      ...
      <section className="mt-12 grid gap-6 md:grid-cols-2">
        <Link
          to="/portal/brands"
          className="group rounded-[var(--radius-card-lg)] border border-border/60 bg-card p-8 transition hover:shadow-[var(--shadow-card)]"
        >
          <Tag className="mb-3 h-7 w-7 text-primary" />
          <h3 className="text-xl font-bold text-heading">Browse the Brand Directory</h3>
          <p className="mt-1 text-sm text-body">
            Discover beauty brands, source products and connect with HQ teams.
          </p>
        ...
        >
          ...
          <p className="mt-1 text-sm text-body">
            Region-wise distributors carrying the brands you want to stock.
          </p>
          <span className="mt-4 inline-flex items-center text-sm font-semibold text-primary group-hover:gap-2">
            Open directory <ArrowRight className="ml-1 h-4 w-4" />
          </span>
